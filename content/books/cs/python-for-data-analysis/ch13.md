...
In [12]: data = pd.DataFrame({....: 'x0': [1, 2, 3, 4, 5],
...
```txt
[ 2. , -0.01, 0. ], [ 3. , 0.25, 3.6 ], [ 4. , -4.1 , 1.3 ], [ 5. , 0. , -2. ]])
```
...
```python
In [29]: data = pd.DataFrame({....: 'x0': [1, 2, 3, 4, 5],
    ....: 'x1': [0.01, -0.01, 0.25, -4.1, 0.],
    ....: 'y': [-1.5, 0., 3.6, 1.3, -2.]})
...
```txt
Intercept x0 x1110.0112 -0.01130.2514 -4.10150.00
Terms:
'Intercept' (column 0)
'x0' (column 1)
'x1' (column 2)
...
x0    x110.012    -0.0130.254    -4.1050.00
Terms:
'x0' (column 0)
'x1' (column 1)
```
...
DesignMatrix with shape (5, 3)
    ...
    110.00995120.00995130.22314141.62924150.00000
Terms:
'Intercept' (column 0)
'x0' (column 1)
...
1 -1.414210.781 -0.707110.7610.000001.0210.70711 -3.3311.414210.77
Terms:
'Intercept' (column 0)
...
```python
In [46]: new_data = pd.DataFrame({....: 'x0': [6, 7, 8, 9],
    ....: 'x1': [3.1, -0.5, 0, 2.3],
    ....: 'y': [1, 2, 3, 4]})
...
Intercept standardize(x0) center(x1)
12.121323.8712.828430.2713.535530.7714.242643.07
...
```python
In [51]: data = pd.DataFrame({....: 'key1': ['a', 'a', 'b', 'b', 'a', 'b', 'a', 'b'],
...
In [59]: data
Out[59]:
    key1 key2 v1 v20 a zero 1 -1.01 a one 20.02 b zero 32.53 b one 4 -0.54 a zero 54.05 b one 6 -1.26 a zero 70.27 b zero 8 -1.7
...
<table><tr><td></td><td>coef</td><td>std err</td><td>t</td><td>P&gt;|t|</td><td>[0.025</td><td>0.975]</td></tr><tr><td>x1</td><td>0.1783</td><td>0.053</td><td>3.364</td><td>0.001</td><td>0.073</td><td>0.283</td></tr><tr><td>x2</td><td>0.2230</td><td>0.046</td><td>4.818</td><td>0.000</td><td>0.131</td><td>0.315</td></tr><tr><td>x3</td><td>0.5010</td><td>0.080</td><td>6.237</td><td>0.000</td><td>0.342</td><td>0.660</td></tr></table>

<table><tr><td>Omnibus:</td><td>4.662</td><td>Durbin-Watson:</td><td>2.201</td></tr><tr><td>Prob(Omnibus):</td><td>0.097</td><td>Jarque-Bera (JB):</td><td>4.098</td></tr><tr><td>Skew:</td><td>0.481</td><td>Prob(JB):</td><td>0.129</td></tr><tr><td>Kurtosis:</td><td>3.243</td><td>Cond. No.</td><td></td></tr></table>
...
Out[76]:
    col0    col1    col2    y
0 -0.129468 -1.2127530.5042250.42786310.302910 -0.435742 -0.254180 -0.6734802 -0.328522 -0.0253020.138351 -0.0908783 -0.351475 -0.719605 -0.258215 -0.48949441.243269 -0.373799 -0.522629 -0.128941
```
...
Out[80]:
0 -0.0023271 -0.14190420.0412263 -0.3230704 -0.100535
dtype: float64
```
...
Name Sex Age SibSp \
0 Braund, Mr. Owen Harris male 22.011 Cumings, Mrs. John Bradley (Florence Briggs Th... female 38.012 Heikkinen, Miss. Laina female 26.003 Futrelle, Mrs. Jacques Heath (Lily May Peel) female 35.01
Parch Ticket Fare Cabin Embarked
00 A/5211717.2500 NaN S
10 PC 1759971.2833 C85 C
20 STON/02. 31012827.9250 NaN S
3011380353.1000 C123 S
```
...
Andreas Mueller and Sarah Guido (O’Reilly)的 《Introduction to Machine Learning withPython》
...
Aurélien Géron (O’Reilly) 的《Hands-On Machine Learning with Scikit-Learn andTensorFlow》
