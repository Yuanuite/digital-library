...
| 周次 | 章节 | 页码 |
|------|------|------|
| 第1周 | 1. 引言(Introduction) | |
| | 1.1 欢迎 | |
| | 1.2 机器学习是什么? | |
| | 1.3 监督学习 | |
| | 1.4 无监督学习 | |
| | 2. 单变量线性回归(Linear Regression) | |
| | 2.1 模型表示 ~ 2.8 接下来的内容 | |
| | 3. 线性代数回顾(Linear Algebra Review) | |
| 第2周 | 4. 多变量线性回归(Linear Regression with Multiple Variables) | |
| | 5. Octave 教程(Octave Tutorial) | |
| 第3周 | 6. 逻辑回归(Logistic Regression) | |
| | 7. 正则化(Regularization) | |
| 第4周 | 8. 神经网络：表述(Neural Networks: Representation) | |
| 第5周 | 9. 神经网络的学习(Neural Networks: Learning) | |
| 第6周 | 10. 应用机器学习的建议(Advice for Applying Machine Learning) | |
| | 11. 机器学习系统的设计(Machine Learning System Design) | |
| 第7周 | 12. 支持向量机(Support Vector Machines) | |
| 第8周 | 13. 聚类(Clustering) | |
| | 14. 降维(Dimensionality Reduction) | |
| 第9周 | 15. 异常检测(Anomaly Detection) | |
| | 16. 推荐系统(Recommender Systems) | |
| 第10周 | 17. 大规模机器学习(Large Scale Machine Learning) | |
| | 18. 图片文字识别(Application Example: Photo OCR) | |
| | 19. 总结(Conclusion) | |
| 附件 | CS229 复习材料 — 线性代数 | |
| | CS229 复习材料 — 概率论 | |
| | 数学基础（国内教材） | |
