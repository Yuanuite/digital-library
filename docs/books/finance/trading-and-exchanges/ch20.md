...
distinguish between them. [Chapter 28](#part0042.html_ch28){.nounder}
...
component introduced in [chapter 13](#part0024.html_ch13){.nounder}.
...
10](#part0020.html_ch10){.nounder} provides a more complete explanation
of the properties of fully informative prices.

------------------------------------------------------------------------

**[▶]{.ent} Gasoline, Diesel Fuel,
...
[[www.eia.doe.gov](http://www.eia.doe.gov){.nounder}]{.weblink}.*
...
electricity than generators could supply. [◀]{.ent1}
...
**[▶]{.ent} Fundamental Volatility in Perishable Commodity Prices**
...
![Image](images/00100.jpeg){.calibre6}
...
![Image](images/00101.jpeg){.calibre6}

so that the price change is

![Image](images/00102.jpeg){.calibre6}

These assumptions imply that the price change variance is

![Image](images/00103.jpeg){.calibre9}
...
![Image](images/00104.jpeg){.calibre9}

Inverting this expression gives

![Image](images/00105.jpeg){.calibre6}
...
In [chapter 21](#part0034.html_ch21){.nounder}, we focus first on
...
important problem. In [chapter 22](#part0035.html_ch22){.nounder}, we
