...
this component in [chapter 13](#part0024.html_ch13){.nounder} when we
...
13](#part0024.html_ch13){.nounder}), it is the difference in the value
...
trader is a buyer
![Image](images/00083.jpeg){.calibre6}
or a seller
![Image](images/00084.jpeg){.calibre6}.
...
![Image](images/00085.jpeg){.calibre9}

**FIGURE 14-2.**\
Quotation Adjustments After a Buyer Arrives

![Image](images/00086.jpeg){.calibre9}
...
14-1](#part0025.html_ch14tab01){.nounder} summarizes why uninformed
...
![Image](images/00087.jpeg){.calibre9}

[Chapter 4](#part0012.html_ch04){.nounder} discusses limit and market
...
[▶]{.ent} **Economists and Their Can Openers**
...
for different types of executed orders. [◀]{.ent1}
...
matching in front of Dieter's order (1 cent). [◀]{.ent1}
...
[▶]{.ent} **Indexed (or Floating) Limit Orders**
...
[▶]{.ent} **Automated Limit Order Management Systems**
...
submitted as market orders. [◀]{.ent1}
...
14-2](#part0025.html_ch14tab02){.nounder} provides a summary of the
...
![Image](images/00088.jpeg){.calibre9}
...
strategies in [chapters 11](#part0021.html_ch11){.nounder} and
...
trading interest. ([Chapter 8](#part0017.html_ch08){.nounder} shows that
...
that we wish we could measure well. [◀]{.ent1}
...
19](#part0031.html_ch19){.nounder}) include the cost of trading large
...
to harmonize its financial markets. [◀]{.ent1}
...
[▶]{.ent} **Why Speeches by Fed Chairmen Are Rarely Interesting**
...
widen when cold air descends into Florida. [◀]{.ent1}

------------------------------------------------------------------------

Practitioners use various methods to predict volatility. Since we
describe these methods in [chapter 20](#part0032.html_ch20){.nounder},
...
[▶]{.ent} **Why Are Shares in Tommy's Burgers Not Publicly Traded?**
...
checking account, it can easily supervise its investment. [◀]{.ent1}
