...
11](#part0021.html_ch11){.nounder} bankruptcy. By the middle of 2000,
...
![Image](images/00112.jpeg){.calibre6}
[◀]{.ent1}
...
than the computational mistake that they reported. [◀]{.ent1}

*Sources:
[[www.time.com/time/rnagazine/1998/dom/980330/business.jail_the_beards
12.html](http://www.time.com/time/rnagazine/1998/dom/980330/business.jail_the_beards12.html){.nounder}]{.weblink}(Overview);
[[www.better-investmg.org/clubs/hom-the-ladies.html](http://www.better-investmg.org/clubs/hom-the-ladies.html){.nounder}]{.weblink}
...
subtract 1 from the product. [◀]{.ent1}
...
would have been worth just 1,037 dollars on May 2, 2001. [◀]{.ent1}
...
investment managers. [◀]{.ent1}

*Source: The AIMR presentation standards appear at
[[www.aimr.com/standards/pps/ppsstand.html](http://www.aimr.com/standards/pps/ppsstand.html){.nounder}]{.weblink}.*
...
classes. [Table 22-1](#part0035.html_ch22tab1){.nounder} provides a list
...
![Image](images/00113.jpeg){.calibre9}

![Image](images/00114.jpeg){.calibre9}
...
savings account, he would have earned 10.3 percent. [◀]{.ent1}
...
benefit of at least one full year of evaluation. [◀]{.ent1}
...
![Image](images/00115.jpeg){.calibre6}
...
[Table 22-2](#part0035.html_ch22tab2){.nounder} presents power
...
![Image](images/00116.jpeg){.calibre9}

![Image](images/00117.jpeg){.calibre9}
...
**[▶]{.ent} One Year of Data Just Doesn't Cut It**
...
is essentially worthless for judging managerial skill. [◀]{.ent1}
...
22-3](#part0035.html_ch22tab3){.nounder} presents the results of these
...
![Image](images/00118.jpeg){.calibre9}
...
commissions:
![Image](images/00119.jpeg){.calibre6}.
...
[Table 22-4](#part0035.html_ch22tab4){.nounder} summarizes this
information.
...
[Table 22-5](#part0035.html_ch22tab5){.nounder} presents results for
...
![Image](images/00122.jpeg){.calibre6}
× 1.15 percent).
...
[Table 22-6](#part0035.html_ch22tab6){.nounder} shows just how lucky the
...
![Image](images/00123.jpeg){.calibre9}

![Image](images/00124.jpeg){.calibre9}
...
likely is a skilled manager. [◀]{.ent1}

*Source: Author's calculations based on data at
[[www.berkshirehathaway.com/2000ar/2000letter.html](http://www.berkshirehathaway.com/2000ar/2000letter.html){.nounder}]{.weblink}.*
...
22-6](#part0035.html_ch22tab6){.nounder} by assuming that the
...
[Table 22-7](#part0035.html_ch22tab7){.nounder} tabulates extreme
...
22-6](#part0035.html_ch22tab6){.nounder} shows that when the correlation
...
![Image](images/00125.jpeg){.calibre9}
...
whether true active managers are skilled. [◀]{.ent1}
...
no such tests have ever been done. [◀]{.ent1}
...
**[▶]{.ent} How to Fool Most People Most of the Time: Sell Volatility**
...
because he was traveling\![◀]{.ent1}

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} The St. Petersburg
...
themselves rather than their clients. [◀]{.ent1}
...
[[www.mark-knutson.com](http://www.mark-knutson.com){.nounder}]{.weblink},
May 31, 2001.*
...
**[▶]{.ent} The Regression of Public Commodity Pools**
...
skilled manager. [◀]{.ent1}

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} More Caveman Psychology**
...
people are skilled and not just lucky. [◀]{.ent1}
...
**[▶]{.ent} It Seems Like Everyone Is a Winner**
...
[Tables 22-8](#part0035.html_ch22tab8){.nounder} and
[22-9](#part0035.html_ch22tab9){.nounder} provide a partial list of the
...
![Image](images/00126.jpeg){.calibre9}

![Image](images/00127.jpeg){.calibre9}
...
![Image](images/00128.jpeg){.calibre9}
...
discussions in [chapters 10-12](#part0020.html_ch10){.nounder} about
...
but not to seek comparative advantage. [◀]{.ent1}

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} Handicapping a Horse Race**
...
22-10](#part0035.html_ch22tab10){.nounder} illustrates these parallels.
[◀]{.ent1}
...
![Image](images/00129.jpeg){.calibre9}
...
In [chapter 23](#part0037.html_ch23){.nounder}, we consider why index
markets are organized as they are. Our discussion shows how uninformed
traders benefit from trading indexes.

[Chapter 24](#part0038.html_ch24){.nounder} examines the specialist
...
preferencing by dealers in [chapter 25](#part0039.html_ch25){.nounder},
why markets consolidate and fragment in [chapter
26](#part0040.html_ch26){.nounder}, and screen-versus floor-based
trading in [chapter 27](#part0041.html_ch27){.nounder}. We pay special
attention to the problems that result when traders can trade the same
instruments in different places.

[Chapter 28](#part0042.html_ch28){.nounder} discusses the origins of
...
[Chapter 29](#part0043.html_ch29){.nounder} considers the benefits and
