...
103.25 immediately. [◀]{.ent1}

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} The Common Cents Stock
Pricing Act of 1997**
...
that incorporate the words "common sense." [◀]{.ent1}
...
**[▶]{.ent} Pro Rata Allocation Example**
...
6-1](#part0014.html_ch06tab1){.nounder} to an auction that uses the pure
price-time precedence hierarchy. An order book that arranges these
orders by pure price-time precedence appears in [table
6-2](#part0014.html_ch06tab2){.nounder}, where the orders with the
...
![Image](images/00037.jpeg){.calibre9}
...
![Image](images/00038.jpeg){.calibre9}
...
[Table 6-3](#part0014.html_ch06tab3){.nounder} summarizes the trades.

The order book with the remaining unfilled orders appears in [table
6-4](#part0014.html_ch06tab4){.nounder}. Note that the buy and sell
...
![Image](images/00039.jpeg){.calibre6}

**TABLE 6-4.**\
Order Book After the Market Call

![Image](images/00040.jpeg){.calibre9}
...
**[▶]{.ent} The Arizona Stock Exchange and Arizona**
...
Arizona's security registration fees. [◀]{.ent1}
...
[table 6-5](#part0014.html_ch06tab5){.nounder} and [figure
6-1](#part0014.html_ch06fig1){.nounder}. To construct these schedules,
...
6-1](#part0014.html_ch06fig1){.nounder}.)

[Table 6-6](#part0014.html_ch06tab6){.nounder} and [figure
6-2](#part0014.html_ch06fig2){.nounder} show that the supply and demand
...
![Image](images/00041.jpeg){.calibre9}

**FIGURE 6-1.**\
Single Price Auction Example Supply and Demand Schedule Plot

![Image](images/00042.jpeg){.calibre9}
...
be (0.28 − 0.23) × 112,000 × 2 = 11,200 dollars. [◀]{.ent1}
...
![Image](images/00043.jpeg){.calibre9}

**FIGURE 6-2.**\
Supply and Demand Schedules Following the Single Price Auction

![Image](images/00044.jpeg){.calibre9}
...
[table 6-7](#part0014.html_ch06tab7){.nounder}. The analysis assumes
...
![Image](images/00045.jpeg){.calibre9}
...
orders appear in [table 6-1](#part0014.html_ch06tab1){.nounder}. This
...
![Image](images/00046.jpeg){.calibre9}
...
![Image](images/00047.jpeg){.calibre9}
...
![Image](images/00048.jpeg){.calibre9}
...
![Image](images/00049.jpeg){.calibre9}
...
![Image](images/00050.jpeg){.calibre9}
...
![Image](images/00051.jpeg){.calibre9}
...
![Image](images/00052.jpeg){.calibre9}

The market has now processed all the example orders from [table
6-1](#part0014.html_ch06tab1){.nounder}. [Table
6-8](#part0014.html_ch06tab8){.nounder} summarizes the trades arranged
...
![Image](images/00053.jpeg){.calibre9}
...
In [chapter 5](#part0013.html_ch05){.nounder}, we argued that the main
...
6-10](#part0014.html_ch06tab10){.nounder} lists the major U.S. crossing
markets.
...
![Image](images/00055.jpeg){.calibre9}

------------------------------------------------------------------------

**[▶]{.ent} Pro Rata Allocation of
...
**[▶]{.ent} Informed Trading in Crossing Networks**
...
**[▶]{.ent} Price Manipulation and Derivative Pricing**
...
**[▶]{.ent} Jesse Livermore's Manipulation of Some Bucketeers**
