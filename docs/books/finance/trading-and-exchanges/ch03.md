...
in [chapter 8](#part0017.html_ch08){.nounder}.

**TABLE 3-1.**\
The Buy Side of the Trading Industry

![Image](images/00008.jpeg){.calibre9}
...
3-1](#part0011.html_ch03tab1){.nounder}.
...
13](#part0024.html_ch13){.nounder}.

------------------------------------------------------------------------

**[▶]{.ent} The Wire in Wirehouse**
...
important in the trading industry. [◀]{.ent1}
...
in [chapter 7](#part0015.html_ch07){.nounder}.
...
3-2](#part0011.html_ch03tab2){.nounder} provides a summary of the sell
...
![Image](images/00009.jpeg){.calibre9}
...
only if the clearing firm detects the bankruptcy. \$[◀]{.ent1}

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} A Typical Set of Relationships**
...
on behalf of the pension fund. [◀]{.ent1}

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} Straight-Through
Processing**
...
instruments appears in [table 3-3](#part0011.html_ch03tab3){.nounder}.

**TABLE 3-3.**\
Trading Instrument Summary

![Image](images/00010.jpeg){.calibre9}
...
stripped bonds to the issuers. [◀]{.ent1}
...
*Source: [[www.liffe.com](http://www.liffe.com){.nounder}]{.weblink}*
...
**[▶]{.ent} Why Discuss Gambling Contracts?**
...
markets throughout this book. [◀]{.ent1}
...
assets. Let's not quibble over this one. [◀]{.ent1}
...
3-4](#part0011.html_ch03tab4){.nounder} characterizes the relative
...
![Image](images/00011.jpeg){.calibre9}
...
**[▶]{.ent} The New York Stock Exchange's Quantitative Listing Standards
...
the preceding two years. [◀]{.ent1}

*Source: NYSE Listed Company Manual at
[[www.nyse.com/listed/listed.html](http://www.nyse.com/listed/listed.html){.nounder}]{.weblink},
...
**[▶]{.ent} Double- and Triple-counting Volumes**
...
3-5](#part0011.html_ch03tab5){.nounder}.

**TABLE 3-5.**\
Some U.S. Equity Markets with 2000 Total Dollar Volumes (billions)

![Image](images/00012.jpeg){.calibre9}
...
[Table 3-6](#part0011.html_ch03tab6){.nounder} presents a summary of
...
exchanges appears in [table 3-7](#part0011.html_ch03tab7){.nounder}.
...
[Table 3-8](#part0011.html_ch03tab8){.nounder} provides a
...
![Image](images/00013.jpeg){.calibre9}

![Image](images/00014.jpeg){.calibre9}

------------------------------------------------------------------------

**[▶]{.ent} Some International Stock
Market Trivia**
...
**[▶]{.ent} Some Options Market Trivia**
...
separate the stock trading from the options trading. [◀]{.ent1}
...
options traded at U.S. exchanges. [◀]{.ent1}
...
![Image](images/00015.jpeg){.calibre9}

**TABLE 3-8.**\
Contract Volumes in Some World Equity Derivatives Markets in 2000
(thousands)

![Image](images/00016.jpeg){.calibre9}

------------------------------------------------------------------------

**[▶]{.ent} An Irony at the NYSE**
...
it was among the earliest innovators in electronic trading. [◀]{.ent1}
...
[Chapter 8](#part0017.html_ch08){.nounder} identifies some of the
...
3-9](#part0011.html_ch03tab9){.nounder} provides a brief summary of the
currently active U.S. futures exchanges.

###### 3.4.4.2 International Futures Markets

[Table 3-10](#part0011.html_ch03tab10){.nounder} lists global futures
...
![Image](images/00017.jpeg){.calibre9}

![Image](images/00018.jpeg){.calibre9}

**TABLE 3-10.**\
Top 40 Global Futures Exchanges by Contract Volume in 2001 (millions)

![Image](images/00019.jpeg){.calibre9}

![Image](images/00020.jpeg){.calibre9}

------------------------------------------------------------------------

**[▶]{.ent} They Trade Enormous
...
[[www.garban.com](http://www.garban.com){.nounder}]{.weblink};
[[www.cantor.com](http://www.cantor.com){.nounder}]{.weblink}*.

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} The Retail Currency Markets**
...
more negotiating clout than you do. [◀]{.ent1}
...
commissions. [Table 3-11](#part0011.html_ch03tab11){.nounder} shows that
...
![Image](images/00021.jpeg){.calibre9}

![Image](images/00022.jpeg){.calibre9}

------------------------------------------------------------------------

**[▶]{.ent} Regulatory Competition**
...
on off-exchange trading, in December 1999. [◀]{.ent1}

*Sources: New York Stock Exchange Archives; Securities and Exchange
Commission Release no. 34-42758 at
[[www.sec.gov/rules/sro/ny9948o.htm](http://www.sec.gov/rules/sro/ny9948o.htm){.nounder}]{.weblink}*.
...
risk. Instead, they now use forward contracts. [◀]{.ent1}
...
**[▶]{.ent} Chartered Financial Analysts**
...
are highly knowledgeable financial professionals. [◀]{.ent1}

*For more information, see
[[www.aimr.org](http://www.aimr.org){.nounder}]{.weblink}*.
