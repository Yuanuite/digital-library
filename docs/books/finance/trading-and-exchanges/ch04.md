...
[chapter 6](#part0014.html_ch06){.nounder}.
...
[chapter 19](#part0031.html_ch19){.nounder} (Liquidity) that immediacy
...
raise the price by 0.90 cents. [◀]{.ent1}
...
4-1](#part0012.html_ch04fig1){.nounder} presents an example of a limit
...
![Image](images/00024.jpeg){.calibre9}
...
4-1](#part0012.html_ch04tab1){.nounder}.
...
[Figure 4-2](#part0012.html_ch04fig2){.nounder} illustrates these
relations.
...
![Image](images/00025.jpeg){.calibre9}
...
**[▶]{.ent} Option Contracts Are Sold Limit Orders**
...
still own the stock, plus, of course, the option premium. [◀]{.ent1}
...
In [chapter 14](#part0025.html_ch14){.nounder}, we show that spreads
...
**[▶]{.ent} Chasing the Price with a Limit Order**
...
ended up paying 9 cents more. [◀]{.ent1}
...
limit order option values ([chapter 11](#part0021.html_ch11){.nounder}),
when bluffers try to persuade other traders to offer liquidity foolishly
([chapter 12](#part0022.html_ch12){.nounder}), when dealers trade with
better-informed traders ([chapter 13](#part0024.html_ch13){.nounder}),
...
At 2:30 [A.M]{.small}. Chicago time, Andy submits a limit buy order for
...
attends to other business. [◀]{.ent1}
...
and a stop price of 10: "Buy 100 ASTN, 10 stop, 10.37 limit."[◀]{.ent1}
...
runners in [chapter 11](#part0021.html_ch11){.nounder}, market
manipulation in [chapter 12](#part0022.html_ch12){.nounder}, and extreme
volatility in [chapter 28](#part0042.html_ch28){.nounder}.
...
4-2](#part0012.html_ch04tab2){.nounder} summarizes differences among
...
![Image](images/00026.jpeg){.calibre9}
...
sell on an uptick. [◀]{.ent1}

------------------------------------------------------------------------

------------------------------------------------------------------------

**[▶]{.ent} Tick-Sensitive Order Example**
...
market sell order arrives, you buy for 1.02. [◀]{.ent1}
...
4-3](#part0012.html_ch04tab3){.nounder}.)
...
![Image](images/00027.jpeg){.calibre9}

------------------------------------------------------------------------

**[▶]{.ent} Rolling Futures Position with Spread Order**
...
**[▶]{.ent} Substitution Order Example**
...
therefore buys Ford and Chrysler to fill the order. [◀]{.ent1}
...
price because you will receive two companies instead of one. [◀]{.ent1}
...
4-4](#part0012.html_ch04tab4){.nounder} provides a summary of the
...
![Image](images/00028.jpeg){.calibre9}
